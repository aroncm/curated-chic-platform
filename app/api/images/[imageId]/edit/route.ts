...
// Google Generative AI Imagen pricing: ~$0.02 per image
...
export async function POST(
  ...
  try {
    console.log(`Processing image with Google Generative AI (Imagen): ${originalImageUrl}`);
    ...
    console.log('Calling Google Generative AI (Imagen 3.0)...');
    ...
    if (!response.candidates || response.candidates.length === 0) {
      throw new Error('No image generated by Google Generative AI');
    }
    ...
    if (!imagePart || !imagePart.inlineData) {
      throw new Error('No image data in Google Generative AI response');
    }
